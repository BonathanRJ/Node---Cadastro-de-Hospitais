...
CREATE TABLE FCO_CARGO (
	IDCGO 		INT 		AUTO_INCREMENT NOT NULL,
	NRCGO 		CHAR(8) 	NOT NULL,
	DCCGO 		VARCHAR(70) NOT NULL,
	AUUSUULTALT VARCHAR(100)NOT NULL,
	AUDATULTALT DATETIME 	NOT NULL,
	PRIMARY KEY(IDCGO)
);
...
CREATE TABLE PAC_ESTADO_CIVIL(
	IDOBJ 		INT 		AUTO_INCREMENT NOT NULL,
	CDESTCIV 	CHAR(2) 	NOT NULL,
	DCESTCIV 	VARCHAR(45) NOT NULL,	
	AUUSUULTALT VARCHAR(100)NOT NULL,
	AUDATULTALT DATETIME 	NOT NULL,
    PRIMARY KEY(IDOBJ)
);

CREATE TABLE PAC_ACOMPANHANTE (
	IDACO       INT 		AUTO_INCREMENT NOT NULL,
	IDHOS 		INT  		NOT NULL,
	CDHOS		CHAR(3)		NOT NULL,
	IDENF 		INT  		NOT NULL,
    CDENF		CHAR(4) 	NOT NULL,
	NRMATACO	CHAR(10) 	NOT NULL,
	NMACO       VARCHAR(75) NOT NULL,
	DTNSCACO    DATETIME 	NOT NULL,
	IDPAC       INT 		NOT NULL,
	NRMATPAC	CHAR(10) 	NOT NULL,
	NRCPFACO    CHAR(11)	NOT NULL,
	NRTELRSDACO VARCHAR(20)	NOT NULL,
	DCEMLACO    VARCHAR(45)	NOT NULL,
	AUUSUULTALT VARCHAR(100)NOT NULL,
	AUDATULTALT DATETIME	NOT NULL,
	PRIMARY KEY(IDACO)
);
